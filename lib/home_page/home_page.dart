  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<ThemeBloc, bool>(builder: (context, bool isDark) {
      return Scaffold(
        ...
        drawer: _drawer(isDark: isDark, context: context),
        body: SafeArea(
          child: Column(
            children: [
              new Container(
                              ...
                              return Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Play_Pause_Button(isDark: isDark,)
                                  ],
                                ),
                              );
                            });
...
class _drawer extends StatelessWidget {
  const _drawer({Key key, @required this.isDark, @required this.context})
      : super(key: key);
        ...
        children: [
          ListTile(
            ...
            trailing: new Switch(
              ...
              onChanged: (value) {
                final x = BlocProvider.of<ThemeBloc>(this.context);
                if (this.isDark)
                  x.add(ThemeEvent.lightTheme);
                else
                  x.add(ThemeEvent.darkTheme);
              },
            ),
          )
        ],
